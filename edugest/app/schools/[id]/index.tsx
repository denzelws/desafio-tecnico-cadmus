...
const Header: React.FC<HeaderProps> = ({ school, onBack, onEdit }) => (
  <GBox bg="$white" px="$4" pt="$4" pb="$3">
    <GHStack alignItems="center" mb="$2">
      <GPressable onPress={onBack} mr="$3">
      ...
      <GPressable onPress={onEdit} ml="$2">
      ...
      header={
        <>
          <Header
            school={school}
            onBack={() => router.back()}
            onEdit={() => router.push(`/schools/${id}/edit`)}
          />
          <SearchFilters
